...
const menu = (prefix, pushname, NickDono, NomeDoBot, isChVip, sender) => {
return`╔♡∞*♡♡∞:｡.｡💛｡.｡:∞♡*♡:∞♡╗
╠═⪩⟨💛𝐒𝐄𝐉𝐀-𝐁𝐄𝐌-𝐕𝐈𝐍𝐃𝐎(𝐀)⟩
╚♡∞*♡♡∞:｡.｡💛｡.｡:∞♡*♡:∞♡╝
╭━━⪩ 愛 INFO BOT | USER 愛 ⪨━━
...
╭━━━⪩ *DIVERSOS* ⪨━━━
│💛⃤${prefix}ship (@@)
│💛⃤${prefix}sadcat (Sandro md)
│💛⃤${prefix}pikachu (Sandro md)
│💛⃤${prefix}supreme (Sandro md)
│💛⃤${prefix}nokia
│💛⃤${prefix}fatos (Sandro)
│💛⃤${prefix}drake (Sandro|bot)
│💛⃤${prefix}advertencia (Atenção)
│💛⃤${prefix}alerta (Cuidado)
│💛⃤${prefix}discord (texto)
...
╚♡∞*♡♡∞:｡.｡💛｡.｡:∞♡*♡:∞♡╝
╭══════════════ ⪩
│💛⃤${prefix}placa (abc1234)
│💛⃤${prefix}cpf (numero)
│💛⃤${prefix}cpf2 (numero)
│💛⃤${prefix}nome (nome)
│💛⃤${prefix}telefone (numero)
╰═══════════════ ⪨`;
};
